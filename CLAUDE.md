...
| **Crypto Backtest Engine** | ❌ Not used | ❌ Not used | ❌ Not used | OHLCV klines from the Binance public REST API (no key required); CSV and synthetic data also supported; Local OHLCV CSV files |
