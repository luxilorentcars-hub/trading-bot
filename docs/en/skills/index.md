...
| [Crypto Backtest Engine]({{ '/en/skills/crypto-backtest-engine/' | relative_url }}) | Event-driven crypto backtesting engine with realistic execution costs, protective exits, position sizing, grid... | <span class="badge badge-free">No API</span> |
